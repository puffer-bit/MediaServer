...
public interface IWebRTCManager : IDisposable
{
    RTCPeerConnection CreatePeerConnection(string userId, string roomId, string peerId, bool isStreamHost,
        bool isAudioRequested, bool isTest);
